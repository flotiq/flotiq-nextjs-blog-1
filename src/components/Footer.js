...
const Footer = () => (
    <footer>
        <div className="max-w-7xl mx-auto pt-12 overflow-hidden lg:px-8">
            <div
                className="w-full md:w-auto px-5 md:px-0 mt-8
                flex justify-between md:justify-center items-center space-x-5 md:space-x-10"
            >
                <Link href="/">
                    <Image
                        className="block h-8 w-auto md:h-10 mr-5 md:mr-10"
                        src={Logo}
                        alt="Flotiq"
                        width={138}
                        height={50}
            ...
            <div
                className="w-full md:w-auto px-5 md:px-0 py-5 mt-7 md:mt-15
