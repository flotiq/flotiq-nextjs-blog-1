...
function BlogpostWithoutInternalAllOfContentFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'blocks': json['blocks'] == null ? undefined : (json['blocks'].map(BlogpostWithoutInternalAllOfContentBlocks_1.BlogpostWithoutInternalAllOfContentBlocksFromJSON)),
...
function BlogpostWithoutInternalAllOfContentToJSON(value) {
    ...
    return {
        'time': value['time'],
        'blocks': value['blocks'] == null ? undefined : (value['blocks'].map(BlogpostWithoutInternalAllOfContentBlocks_1.BlogpostWithoutInternalAllOfContentBlocksToJSON)),
