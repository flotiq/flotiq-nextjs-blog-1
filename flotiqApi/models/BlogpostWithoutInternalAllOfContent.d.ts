 ...
 */
import type { BlogpostWithoutInternalAllOfContentBlocks } from './BlogpostWithoutInternalAllOfContentBlocks';
/**
 *
 * @export
 * @interface BlogpostWithoutInternalAllOfContent
 */
export interface BlogpostWithoutInternalAllOfContent {
    /**
     *
     * @type {number}
     * @memberof BlogpostWithoutInternalAllOfContent
     */
    time?: number;
    /**
     *
     * @type {Array<BlogpostWithoutInternalAllOfContentBlocks>}
     * @memberof BlogpostWithoutInternalAllOfContent
     */
    blocks?: Array<BlogpostWithoutInternalAllOfContentBlocks>;
    /**
     *
     * @type {string}
     * @memberof BlogpostWithoutInternalAllOfContent
