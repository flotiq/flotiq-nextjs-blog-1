 ...
 *
 * @export
 * @interface BlogpostWithoutInternalAllOfContentBlocks
 */
export interface BlogpostWithoutInternalAllOfContentBlocks {
    /**
     *
     * @type {string}
     * @memberof BlogpostWithoutInternalAllOfContentBlocks
     */
    id?: string;
    /**
     *
