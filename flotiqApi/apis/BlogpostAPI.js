 ...
 *
 */
class BlogpostAPI extends runtime.BaseAPI {
    /**
    ...
    createRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.BlogpostFromJSON)(jsonValue));
        });
    }
    /**
     * Allows you to create object of Blog post type. <br />
    ...
    listRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.BlogpostListFromJSON)(jsonValue));
        });
    }
    /**
     * List objects of Blog post type. <br />
    ...
    listVersionRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.BlogpostVersionsListFromJSON)(jsonValue));
        });
    }
    /**
     * List objects versions of Blog post type. <br />
